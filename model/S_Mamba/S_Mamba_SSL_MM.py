...
class Encoder(nn.Module):
    ...
    def forward(self, x, attn_mask=None, tau=None, delta=None,train=False,mi=0):
        # x [B, L, D]
        attns = []
...
class Model(nn.Module):
    ...
    def pretrain(self, x_enc, x_mark_enc,train,mi=False):
        ...
        enc_out, attns = self.encoder(enc_out, attn_mask=None,train=train,mi=mi)
        enc_out = enc_out[:,:N,:]
    ...
    def forward(self, x_enc, x_mark_enc, x_dec, x_mark_dec, mask=None,train=777,mi=777):
        dec_out = self.forecast(x_enc, x_mark_enc, x_dec, x_mark_dec)
        return dec_out[:, -self.pred_len:, :],0  # [B, L, D]s